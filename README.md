...
Right now, installation supports [CentOS](https://www.centos.org) 7,
[Red Hat](https://www.redhat.com) 9 (which also works with RHEL lookalikes such as
[Rocky Linux](https://rockylinux.org)), and macOS. Actual Docker installation is handled
by the installation script. If needed, you can use the stacks installer separately on any
container host1 by running [stacks/setup.sh](./stacks/setup.sh).
